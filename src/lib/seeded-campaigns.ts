...
const PARKING_FINE_ESCALATED: Grievance = (() => {
  const timeline = eventsAt([
    ...
    { daysAgo: 30, kind: "drafted", summary: "Drafted appeal challenging signage compliance.", payload: { draft: { subject: "Formal appeal — PCN PE-2026-44913", body: "To ParkingEye Appeals Team,\n\nI am formally appealing PCN PE-2026-44913 issued on 31 March 2026 at the Westgate retail park.\n\nThe signage at the entry to the site does not meet the British Parking Association Code of Practice §18.3 minimum size requirement and is partially obscured by tree growth. Photographic evidence is attached. Under Schedule 4 of the Protection of Freedoms Act 2012, an enforceable contract requires adequate signage; that condition is not met here.\n\nPlease cancel the charge within 14 days. If this appeal is rejected, I will escalate to POPLA with the same evidence pack." } } },
...
const SUBSCRIPTION_WON: Grievance = (() => {
  const timeline = eventsAt([
    ...
    { daysAgo: 46, kind: "drafted", summary: "Drafted refund demand citing Section 50 CRA.", payload: { draft: { subject: "Refund demand — PG-MEM-882144", body: "Member Services,\n\nMembership PG-MEM-882144 was cancelled on 15 January 2026 with a written request retained on file. PureGym continued to debit £23.00 per month from January through May, totalling £127.00.\n\nUnder Consumer Rights Act 2015 Section 50 and Consumer Contracts Regulations 2013 Regulation 36, the cancellation should have been processed within 14 days of receipt. The continued charges are unauthorised.\n\nPlease refund £127.00 to the original payment card within 14 days. If this is not resolved I will refer the matter to the Competition and Markets Authority and pursue a card chargeback." } } },
...
const TRAIN_DELAY_AWAITING_APPROVAL: Grievance = (() => {
  const timeline = eventsAt([
    ...
    { daysAgo: 0, kind: "drafted", summary: "Drafted Delay Repay claim for £63.75 — awaiting user approval", payload: { draft: { subject: "Delay Repay claim — Avanti 19:40 MAN→EUS, 1 May 2026", body: "Avanti Delay Repay Team,\n\nMy Anytime Single (£127.50) for the 19:40 Manchester Piccadilly to London Euston service on 1 May 2026 arrived 47 minutes late at Euston.\n\nUnder the Delay Repay 15 schedule the 30–59 minute band entitles me to 50% of the single fare paid, which is £63.75.\n\nPlease process payment to the original card within the 20-working-day window prescribed by the National Rail Conditions of Travel. Booking reference and ticket scan attached." } } },
